#!/bin/bash
#SBATCH --job-name=pi05_publish_cable_clip
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_cable_clip — raw checkpoint publish to Hugging Face.
#
...
#   cd /home/u6kr/lorenzo.u6kr/openpi_so101_cable_clip_remote
#   sbatch slurm/publish_so101_cable_clip_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_so101_cable_clip_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_so101_cable_clip_slurm.sh
#
# Before sbatch:
...
repo_dir="${home_dir}/openpi_so101_cable_clip_remote"
...
CONFIG_NAME="pi05_so101_cable_clip"
EXP_NAME="so101_cable_clip"
HF_REPO_ID="lorenzouttini/pi05-so101-cable-clip-isambard"
