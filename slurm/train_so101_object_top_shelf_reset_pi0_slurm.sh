#!/bin/bash
#SBATCH --job-name=pi0_so101_object_top_shelf_reset
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_so101_object_top_shelf_reset — SO101 resetting object from top shelf (6D joint-space, delta actions).
# Model: pi0 (NOT pi0.5). Dataset: pravsels/object_top_shelf_reset_remote (av1 + uniform
# resolution, 50 episodes, public). Checkpoints publish to lorenzouttini.
...
#   sbatch slurm/train_so101_object_top_shelf_reset_pi0_slurm.sh
#
# Before first sbatch:
