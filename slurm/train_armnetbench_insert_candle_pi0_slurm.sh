#!/bin/bash
#SBATCH --job-name=pi0_armnetbench_insert_candle
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_insert_candle — bimanual SO101 inserting a candle into a holder (12D dual-arm joint-space, delta actions). Cameras top/left_wrist/right_wrist.
# Model: pi0 (NOT pi0.5). Dataset: villekuosmanen/armnetbench_insert_candle (av1 + uniform
...
#   sbatch slurm/train_armnetbench_insert_candle_pi0_slurm.sh
#
# Before first sbatch:
#   - openpi_arm64.sif at ${data_dir}/container/
#   - pi0_base weights at ${data_dir}/weights/pi0_base/params
