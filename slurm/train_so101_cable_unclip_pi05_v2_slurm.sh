#!/bin/bash
#SBATCH --job-name=pi05_so101_cable_unclip_v2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_cable_unclip_v2 — SO101 unclipping cable from holder (6D joint-space, delta actions).
# Model: pi0.5 (pi05=True). Dataset: pravsels/cable_unclip_remote (av1 + uniform
...
#   sbatch slurm/train_so101_cable_unclip_pi05_v2_slurm.sh
#
# Before first sbatch:
