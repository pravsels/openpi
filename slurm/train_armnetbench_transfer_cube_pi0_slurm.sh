#!/bin/bash
#SBATCH --job-name=pi0_armnetbench_transfer_cube
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_transfer_cube — bimanual SO101 transferring a cube between the two arms (12D dual-arm joint-space, delta actions). Cameras top/left_wrist/right_wrist.
# Model: pi0 (NOT pi0.5). Dataset: villekuosmanen/armnetbench_transfer_cube (av1 + uniform
...
#   sbatch slurm/train_armnetbench_transfer_cube_pi0_slurm.sh
#
# Before first sbatch:
