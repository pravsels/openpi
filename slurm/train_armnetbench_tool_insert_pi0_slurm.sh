#!/bin/bash
#SBATCH --job-name=pi0_armnetbench_tool_insert
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_tool_insert — SO101 inserting tool into holder (6D joint-space, delta actions).
# Model: pi0 (NOT pi0.5). Dataset: villekuosmanen/armnetbench_tool_insert (av1 + uniform
...
#   sbatch slurm/train_armnetbench_tool_insert_pi0_slurm.sh
#
# Before first sbatch:
