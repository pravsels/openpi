#!/bin/bash
#SBATCH --job-name=pi05_armnetbench_block_stack
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_armnetbench_block_stack — SO101 stacking blocks (6D joint-space, delta actions).
# Model: pi05 (NOT pi05.5). Dataset: villekuosmanen/armnetbench_block_stack (av1 + uniform
...
#   sbatch slurm/train_armnetbench_block_stack_pi05_slurm.sh
#
# Before first sbatch:
