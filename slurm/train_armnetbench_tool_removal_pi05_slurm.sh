#!/bin/bash
#SBATCH --job-name=pi05_armnetbench_tool_removal
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_armnetbench_tool_removal — SO101 removing tool from holder (6D joint-space, delta actions).
# Model: pi05 (NOT pi05.5). Dataset: villekuosmanen/armnetbench_tool_removal (av1 + uniform
...
#   sbatch slurm/train_armnetbench_tool_removal_pi05_slurm.sh
#
# Before first sbatch:
