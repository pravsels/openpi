#!/bin/bash
#SBATCH --job-name=pi05_publish_cable_clip_v2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_cable_clip_v2 — raw checkpoint publish to Hugging Face.
#
...
#   sbatch slurm/publish_so101_cable_clip_pi05_v2_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_so101_cable_clip_pi05_v2_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_so101_cable_clip_pi05_v2_slurm.sh
#
# Before sbatch:
...
CONFIG_NAME="pi05_so101_cable_clip_v2"
EXP_NAME="so101_cable_clip_pi05_v2"
HF_REPO_ID="lorenzouttini/pi05-so101-cable-clip-isambard-v2"
