#!/bin/bash
#SBATCH --job-name=pi0_publish_armnetbench_open_lamp_door
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_open_lamp_door — raw checkpoint publish to Hugging Face.
#
...
#   sbatch slurm/publish_armnetbench_open_lamp_door_pi0_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_armnetbench_open_lamp_door_pi0_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_armnetbench_open_lamp_door_pi0_slurm.sh
#
# Before sbatch:
...
repo_dir="${home_dir}/openpi_so101_pi0_cable_shelf"
...
CONFIG_NAME="pi0_armnetbench_open_lamp_door"
EXP_NAME="armnetbench_open_lamp_door_pi0"
HF_REPO_ID="lorenzouttini/pi0-so101-armnetbench-open-lamp-door-isambard"
