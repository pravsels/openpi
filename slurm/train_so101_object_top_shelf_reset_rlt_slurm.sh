#!/bin/bash
#SBATCH --job-name=pi05_rlt_so101_object_top_shelf_reset
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_rlt_so101_object_top_shelf_reset — Stage-1 RL-token training for SO101.
#
...
#
# Dataset: pravsels/object_top_shelf_reset_remote (public, 50 episodes).
...
#   sbatch slurm/train_so101_object_top_shelf_reset_rlt_slurm.sh
#
# Before first sbatch:
#   - openpi_arm64.sif at ${data_dir}/container/
#   - Baseline VLA at ${data_dir}/checkpoints/pi05_so101_object_top_shelf_reset_v50/step_24999/params
#       hf download lorenzouttini/pi05-so101-object-top-shelf-reset-isambard-v50 \
#         --local-dir ${data_dir}/checkpoints/pi05_so101_object_top_shelf_reset_v50
#     (the published repo nests weights under step_24999/; the RLT TrainConfig's
#      weight_loader points at .../step_24999/params — keep them in sync)
#   - HF / W&B tokens in ${scratch_dir}/.secrets/
#   - The pi05_rlt_so101_object_top_shelf_reset TrainConfig present in this
...
# --- Experiment ---
CONFIG_NAME="pi05_rlt_so101_object_top_shelf_reset"
EXP_NAME="so101_object_top_shelf_reset_rlt"
