#!/bin/bash
#SBATCH --job-name=pi05_so101_cable_clip
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# pi05_so101_cable_clip — SO101 clipping cable into holder (6D joint-space, delta actions).
# Remote-teleop dataset villekuosmanen/cable_clip_remote_v2 (public, apache-2.0).
...
#   sbatch slurm/train_so101_cable_clip_slurm.sh
#
# Before first sbatch:
