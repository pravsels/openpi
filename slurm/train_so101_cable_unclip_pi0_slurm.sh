#!/bin/bash
#SBATCH --job-name=pi0_so101_cable_unclip
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_so101_cable_unclip — SO101 unclipping cable from holder (6D joint-space, delta actions).
# Model: pi0 (NOT pi0.5). Dataset: pravsels/cable_unclip_remote (av1 + uniform
...
#   sbatch slurm/train_so101_cable_unclip_pi0_slurm.sh
#
# Before first sbatch:
