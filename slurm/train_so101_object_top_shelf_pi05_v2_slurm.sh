#!/bin/bash
#SBATCH --job-name=pi05_so101_object_top_shelf_v2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_object_top_shelf_v2 — SO101 placing object on top shelf (6D joint-space, delta actions).
# Model: pi0.5 (pi05=True). Dataset: pravsels/object_top_shelf_remote (av1 + uniform
...
#   sbatch slurm/train_so101_object_top_shelf_pi05_v2_slurm.sh
#
# Before first sbatch:
