#!/bin/bash
#SBATCH --job-name=pi0_armnetbench_tool_removal
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_tool_removal — SO101 removing tool from holder (6D joint-space, delta actions).
# Model: pi0 (NOT pi0.5). Dataset: villekuosmanen/armnetbench_tool_removal (av1 + uniform
...
#   sbatch slurm/train_armnetbench_tool_removal_pi0_slurm.sh
#
# Before first sbatch:
