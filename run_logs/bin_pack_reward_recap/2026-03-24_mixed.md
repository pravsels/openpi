...
## Status
- 2026-03-24 12:30 — running, step 19200, loss 0.0111, rate 1.7 it/s, ~13h remaining. Started at step 0 (loss 0.5005) — high initial loss expected since mixed mode introduces negative demonstrations the model hasn't seen. Loss dropped rapidly to ~0.011 by step 19k.

## Results

## W&B
- local: `wandb/offline-run-20260324_092024-vvd1y2sk`
- synced: https://wandb.ai/pravsels/recap_plain/runs/vvd1y2sk
- notes:

## HuggingFace
- repo: https://huggingface.co/pravsels/pi05-bin-pack-reward-recap-mixed
