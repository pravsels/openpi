#!/bin/bash
#SBATCH --job-name=pi05_so101_object_top_shelf
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# pi05_so101_object_top_shelf — SO101 placing object on top shelf (6D joint-space, delta actions).
# Remote-teleop dataset villekuosmanen/object_top_shelf_remote (public, apache-2.0).
