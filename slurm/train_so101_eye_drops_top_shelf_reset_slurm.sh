#!/bin/bash
#SBATCH --job-name=pi05_so101_eye_drops_top_shelf_reset
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# pi05_so101_eye_drops_top_shelf_reset — SO101 resetting eye drops from top shelf (6D joint-space, delta actions).
#
...
#   sbatch slurm/train_so101_eye_drops_top_shelf_reset_slurm.sh
#
# Before first sbatch:
