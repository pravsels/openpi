#!/bin/bash
#SBATCH --job-name=pi0_publish_armnetbench_insert_candle
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_insert_candle — raw checkpoint publish to Hugging Face.
#
...
#   sbatch slurm/publish_armnetbench_insert_candle_pi0_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_armnetbench_insert_candle_pi0_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_armnetbench_insert_candle_pi0_slurm.sh
#
# Before sbatch:
...
CONFIG_NAME="pi0_armnetbench_insert_candle"
EXP_NAME="armnetbench_insert_candle_pi0"
HF_REPO_ID="lorenzouttini/pi0-so101-armnetbench-insert-candle-isambard"
