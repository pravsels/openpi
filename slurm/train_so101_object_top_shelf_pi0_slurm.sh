#!/bin/bash
#SBATCH --job-name=pi0_so101_object_top_shelf
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_so101_object_top_shelf — SO101 placing object on top shelf (6D joint-space, delta actions).
# Model: pi0 (NOT pi0.5). Dataset: pravsels/object_top_shelf_remote (av1 + uniform
...
#   sbatch slurm/train_so101_object_top_shelf_pi0_slurm.sh
#
# Before first sbatch:
