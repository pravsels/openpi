#!/bin/bash
#SBATCH --job-name=pi05_so101_eye_drops_top_shelf_v2
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# pi05_so101_eye_drops_top_shelf_v2 — SO101 placing eye drops on top shelf (101 episodes, 6D joint-space, delta actions).
#
...
#   sbatch slurm/train_so101_eye_drops_top_shelf_v2_slurm.sh
#
# Before first sbatch:
