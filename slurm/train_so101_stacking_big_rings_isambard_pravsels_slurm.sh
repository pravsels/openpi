#!/bin/bash
#SBATCH --job-name=pi05_big_rings_prs
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# pi05_so101_stacking_big_rings — pravsels Isambard run (does not modify Lorenzo's slurm script).
#
# Cluster: Isambard u6kr. Submit from the pravsels worktree:
#   cd /home/u6kr/pravsels.u6kr/openpi_so101_stacking_big_rings_pravsels
#   sbatch slurm/train_so101_stacking_big_rings_isambard_pravsels_slurm.sh
#
# Branch: task/stack-big-rings-pravsels
#
# Before first sbatch:
...
# --- Infrastructure (u6kr, pravsels) ---
home_dir="/home/u6kr/pravsels.u6kr"
scratch_dir="/scratch/u6kr/pravsels.u6kr"
repo_dir="${home_dir}/openpi_so101_stacking_big_rings_pravsels"
