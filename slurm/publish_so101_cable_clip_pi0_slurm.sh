#!/bin/bash
#SBATCH --job-name=pi0_publish_cable_clip
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_so101_cable_clip — raw checkpoint publish to Hugging Face.
#
...
#   sbatch slurm/publish_so101_cable_clip_pi0_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_so101_cable_clip_pi0_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_so101_cable_clip_pi0_slurm.sh
#
# Before sbatch:
...
CONFIG_NAME="pi0_so101_cable_clip"
EXP_NAME="so101_cable_clip_pi0"
HF_REPO_ID="lorenzouttini/pi0-so101-cable-clip-isambard"
