#!/bin/bash
#SBATCH --job-name=pi0_so101_cable_clip
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_so101_cable_clip — SO101 clipping cable into holder (6D joint-space, delta actions).
# Model: pi0 (NOT pi0.5). Dataset: pravsels/cable_clip_remote_v2 (av1 + uniform
...
#   sbatch slurm/train_so101_cable_clip_pi0_slurm.sh
#
# Before first sbatch:
