#!/bin/bash
#SBATCH --job-name=pi05_rlt_tool_insert
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# pi05_rlt_armnetbench_tool_insert — RLT Stage 1 for SO101 tool insertion.
# Starts from the published pi05 v50 tool-insert checkpoint and trains only the
...
#   - branch task/rlt_robometer pulled in ${repo_dir}
...
# --- Experiment ---
CONFIG_NAME="pi05_rlt_armnetbench_tool_insert"
