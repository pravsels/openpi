#!/bin/bash
#SBATCH --job-name=pi0_armnetbench_open_lamp_door
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_open_lamp_door — bimanual SO101 opening a lamp door (12D dual-arm joint-space, delta actions). Cameras top/left_wrist/right_wrist.
# Model: pi0 (NOT pi0.5). Dataset: villekuosmanen/armnetbench_open_lamp_door (av1 + uniform
...
#   sbatch slurm/train_armnetbench_open_lamp_door_pi0_slurm.sh
#
# Before first sbatch:
