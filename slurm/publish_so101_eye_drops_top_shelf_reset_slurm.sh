#!/bin/bash
#SBATCH --job-name=pi05_publish_eye_drops_reset
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_eye_drops_top_shelf_reset — raw checkpoint publish to Hugging Face.
#
...
#   cd /home/u6kr/lorenzo.u6kr/openpi_so101_eye_drops_top_shelf_reset
#   sbatch slurm/publish_so101_eye_drops_top_shelf_reset_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_so101_eye_drops_top_shelf_reset_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_so101_eye_drops_top_shelf_reset_slurm.sh
#
# Before sbatch:
...
repo_dir="${home_dir}/openpi_so101_eye_drops_top_shelf_reset"
...
CONFIG_NAME="pi05_so101_eye_drops_top_shelf_reset"
EXP_NAME="so101_eye_drops_top_shelf_reset"
HF_REPO_ID="lorenzouttini/pi05-so101-eye-drops-top-shelf-reset-isambard"
