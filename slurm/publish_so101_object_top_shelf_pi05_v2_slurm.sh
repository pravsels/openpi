#!/bin/bash
#SBATCH --job-name=pi05_publish_object_top_shelf_v2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_object_top_shelf_v2 — raw checkpoint publish to Hugging Face.
#
...
#
# Cross-account note: training data is owned by the `pravsels` HF account,
...
#   cd /home/u6kr/lorenzo.u6kr/openpi_so101_pi05_v2
#   sbatch slurm/publish_so101_object_top_shelf_pi05_v2_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_so101_object_top_shelf_pi05_v2_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_so101_object_top_shelf_pi05_v2_slurm.sh
#
# Before sbatch:
...
repo_dir="${home_dir}/openpi_so101_pi05_v2"
...
CONFIG_NAME="pi05_so101_object_top_shelf_v2"
EXP_NAME="so101_object_top_shelf_pi05_v2"
HF_REPO_ID="lorenzouttini/pi05-so101-object-top-shelf-isambard-v2"
