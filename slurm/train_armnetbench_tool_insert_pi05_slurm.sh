#!/bin/bash
#SBATCH --job-name=pi05_armnetbench_tool_insert
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_armnetbench_tool_insert — SO101 inserting tool into holder (6D joint-space, delta actions).
# Model: pi05 (NOT pi05.5). Dataset: villekuosmanen/armnetbench_tool_insert (av1 + uniform
...
#   sbatch slurm/train_armnetbench_tool_insert_pi05_slurm.sh
#
# Before first sbatch:
