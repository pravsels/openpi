#!/bin/bash
#SBATCH --job-name=pi05_publish_object_top_shelf_reset
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_object_top_shelf_reset — raw checkpoint publish to Hugging Face.
#
...
#   TRAIN_JOB=$(sbatch --parsable slurm/train_so101_object_top_shelf_reset_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_so101_object_top_shelf_reset_slurm.sh
#
# Before sbatch:
