#!/bin/bash
#SBATCH --job-name=pi05_publish_object_top_shelf
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_so101_object_top_shelf — raw checkpoint publish to Hugging Face.
#
...
#   sbatch slurm/publish_so101_object_top_shelf_slurm.sh
#
# Auto-run after training (uploads once training succeeds):
#   TRAIN_JOB=$(sbatch --parsable slurm/train_so101_object_top_shelf_slurm.sh)
#   sbatch --dependency=afterok:${TRAIN_JOB} slurm/publish_so101_object_top_shelf_slurm.sh
#
# Before sbatch:
...
CONFIG_NAME="pi05_so101_object_top_shelf"
EXP_NAME="so101_object_top_shelf"
HF_REPO_ID="lorenzouttini/pi05-so101-object-top-shelf-isambard"
