#!/bin/bash
#SBATCH --job-name=pi05_armnetbench_insert_candle
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi05_armnetbench_insert_candle — bimanual SO101 inserting a candle into a holder (12D dual-arm joint-space, delta actions). Cameras top/left_wrist/right_wrist.
# Model: pi05 (NOT pi05.5). Dataset: villekuosmanen/armnetbench_insert_candle (av1 + uniform
...
#   sbatch slurm/train_armnetbench_insert_candle_pi05_slurm.sh
#
# Before first sbatch:
