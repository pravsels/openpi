#!/bin/bash
#SBATCH --job-name=pi05_so101_eye_drops_top_shelf
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# pi05_so101_eye_drops_top_shelf — SO101 placing eye drops on top shelf (6D joint-space, delta actions).
#
...
#   sbatch slurm/train_so101_eye_drops_top_shelf_slurm.sh
#
# Before first sbatch:
...
# --- Experiment ---
CONFIG_NAME="pi05_so101_eye_drops_top_shelf"
