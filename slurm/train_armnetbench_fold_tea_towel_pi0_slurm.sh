#!/bin/bash
#SBATCH --job-name=pi0_armnetbench_fold_tea_towel
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
# pi0_armnetbench_fold_tea_towel — bimanual SO101 folding a tea towel (12D dual-arm joint-space, delta actions). Cameras top/left_wrist/right_wrist.
# Model: pi0 (NOT pi0.5). Dataset: villekuosmanen/armnetbench_fold_tea_towel (av1 + uniform
...
#   sbatch slurm/train_armnetbench_fold_tea_towel_pi0_slurm.sh
#
# Before first sbatch:
